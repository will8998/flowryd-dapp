    ...
    <div className="h-full flex flex-col p-10 space-y-10 overflow-y-auto custom-scrollbar bg-[#020202]">
      <div className="flex justify-between items-end bg-black/20 backdrop-blur-md p-8 border border-white/5 rounded-[40px]">
        <div className="space-y-1">
          <h2 className="text-4xl font-black italic font-mono uppercase tracking-tighter text-emerald-500">Flowryd Collective</h2>
          <p className="text-white/40 text-sm font-mono lowercase tracking-tight">Institutional service marketplace • Strategy, Dev, Creative</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {COLLECTIVE.filter(c => c.category === selectedCategory).map((member, i) => (
          ...
          >
             ...
             <div className="space-y-4 relative z-10">
                ...
                <h3 className="text-3xl font-black italic font-mono uppercase tracking-tighter leading-tight">{member.name}</h3>
                <p className="text-sm text-white/40 leading-relaxed font-medium italic font-mono lowercase tracking-tight">{member.desc}</p>
             </div>
             ...
             <div className="space-y-4 relative z-10 pt-4 border-t border-white/5">
                ...
                <button className="w-full py-4 bg-white text-black rounded-2xl font-black italic font-mono text-xs uppercase tracking-widest hover:bg-emerald-50 transition-all flex items-center justify-center gap-2 group/btn">
        ...
        <div className="bg-emerald-600 rounded-[40px] p-10 flex flex-col justify-center items-center text-center space-y-6 relative overflow-hidden group cursor-pointer shadow-xl shadow-emerald-900/40">
           ...
           <div className="space-y-2">
             <h3 className="text-2xl font-black italic font-mono uppercase tracking-tighter">Join Collective</h3>
             <p className="text-emerald-100/60 text-xs">Offer your institutional services to 400+ parties.</p>
           </div>
           <button className="w-full py-4 bg-black text-emerald-500 rounded-2xl font-black italic font-mono text-xs uppercase tracking-widest">Apply Now</button>
        </div>
      </div>
    </div>
  );
