          ...
          <ParticipantTray />
            ...
            <div className="flex-1 relative min-h-0 flex flex-col">
              <div className="p-6 absolute top-0 left-0 z-10 pointer-events-none">
                 <h2 className="text-xl font-black italic font-mono uppercase tracking-tighter text-blue-500">Flow Workbench</h2>
            ...
            {nodes.length > 1 && (
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
                  <button 
                    className="px-10 py-4 bg-white text-black rounded-2xl font-black italic font-mono text-lg shadow-2xl hover:scale-105 transition-all flex items-center gap-3 opacity-50 cursor-not-allowed"
                  >
