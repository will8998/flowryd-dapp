    ...
    <div className="h-full flex flex-col p-6 space-y-6 overflow-y-auto custom-scrollbar">
      <div className="flex justify-between items-end bg-black/40 backdrop-blur-md p-6 border border-white/5 rounded-[32px]">
        ...
        <div className="px-4 py-1.5 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
          <p className="text-[8px] font-bold text-emerald-500 uppercase tracking-widest">3 Active Rooms</p>
        </div>
      </div>
        ...
        {DEALS.map((deal, i) => (
          ...
          >
               ...
               <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center">
                ...
                <div className="space-y-0.5">
                  ...
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-[8px] text-white/20 uppercase">{deal.participants.join(' • ')}</span>
                  </div>
               </div>
            </div>
            ...
            <div className="flex items-center gap-6">
               ...
               <button className="px-4 py-2 bg-white text-black rounded-lg font-bold text-[9px] uppercase tracking-widest hover:bg-emerald-50 transition-all flex items-center gap-1.5 group/btn">
