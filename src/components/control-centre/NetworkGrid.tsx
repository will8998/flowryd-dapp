      ...
      <div className="px-8 pt-8 pb-6 border-b border-white/5 space-y-6 bg-black/20 backdrop-blur-md z-10">
        <div className="flex justify-between items-end">
          <div className="space-y-1">
            <h2 className="text-3xl font-bold font-sans uppercase tracking-tighter text-blue-500">Discover Network</h2>
                  ...
                  <LiquidGlass className="p-4 border-blue-500/10 hover:border-blue-500/50 bg-blue-500/5 hover:bg-blue-500/10 transition-all">
                     <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center gap-2">
                           ...
                           <h3 className="text-xs font-bold font-sans uppercase text-white group-hover:text-blue-400 transition-colors truncate w-32">{stack.name}</h3>
                        </div>
