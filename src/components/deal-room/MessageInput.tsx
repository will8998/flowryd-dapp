...
export default function MessageInput({ dealId }: MessageInputProps) {
  ...
  return (
    <div className="px-4 py-3">
      ...
      <div className="flex items-end gap-2 bg-white/[0.02] border border-white/[0.06] rounded-xl px-3 py-2.5 focus-within:border-white/10 transition-colors">
        <div className="flex-1 min-w-0">
          <textarea
            ref={textareaRef}
            value={message}
        ...
        <button
          ...
          className="w-7 h-7 rounded-lg bg-emerald-500 text-black flex items-center justify-center hover:bg-emerald-400 transition-all disabled:opacity-30 disabled:cursor-not-allowed shrink-0"
        >
          {isSending ? (
