          ...
          >
            <div className="flex justify-between items-start mb-12">
              ...
              <div className="text-right">
                <span className="px-4 py-1.5 bg-green-500/20 text-green-400 border border-green-500/20 rounded-full text-[10px] font-bold tracking-wide">
                  Flow Ready
                </span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-12">
              <div className="space-y-6">
                <h3 className="text-xs font-bold text-white/40 tracking-wide border-b border-white/5 pb-2">Participants & Shares</h3>
              ...
              <div className="space-y-8">
                <h3 className="text-xs font-bold text-white/40 tracking-wide border-b border-white/5 pb-2">Network Projections</h3>
                
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 text-white/40 mb-1">
                      <Zap className="w-3 h-3" />
                      <span className="text-[10px]">Daily Commits</span>
                    </div>
